...
HD_PWD='E:/University/4course/SystemOnTheChip/Labs/3/SoC_Lab3/integration/lab_1.runs/design_1_log2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_log2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_log2_0_0.tcl
