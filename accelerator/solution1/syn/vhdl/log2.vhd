...
architecture behav of log2 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "log2,hls_ip_2019_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100t-csg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.263000,HLS_SYN_LAT=173,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=7,HLS_SYN_FF=2231,HLS_SYN_LUT=2384,HLS_VERSION=2019_1}";
    ...
    signal empty_reg_69 : STD_LOGIC_VECTOR (31 downto 0);
    signal k_0_reg_81 : STD_LOGIC_VECTOR (5 downto 0);
    signal pow_b_0_reg_93 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal a_reg_222 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_phi_mux_empty_phi_fu_73_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_mux_k_0_phi_fu_85_p4 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_phi_mux_pow_b_0_phi_fu_96_p4 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component log2_fadd_32ns_32bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component log2_fmul_32ns_32cud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component log2_fdiv_32ns_32dEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component log2_sitofp_32ns_eOg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component log2_AXILiteS_s_axi IS
    generic (
...
begin
    log2_AXILiteS_s_axi_U : component log2_AXILiteS_s_axi
    generic map (
    ...
    log2_fadd_32ns_32bkb_U1 : component log2_fadd_32ns_32bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    log2_fadd_32ns_32bkb_U2 : component log2_fadd_32ns_32bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    log2_fmul_32ns_32cud_U3 : component log2_fmul_32ns_32cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    log2_fdiv_32ns_32dEe_U4 : component log2_fdiv_32ns_32dEe
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    log2_sitofp_32ns_eOg_U5 : component log2_sitofp_32ns_eOg
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    empty_reg_69_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    k_0_reg_81_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln15_reg_193 = ap_const_lv1_0))) then 
                k_0_reg_81 <= k_reg_207;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state26)) then 
    ...
    pow_b_0_reg_93_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln15_reg_193_pp0_iter2_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then 
                pow_b_0_reg_93 <= pow_b_1_reg_217;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state26)) then 
                pow_b_0_reg_93 <= b_reg_181;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    ap_phi_mux_empty_phi_fu_73_p4 <= empty_reg_69;
    ...
    ap_phi_mux_k_0_phi_fu_85_p4_assign_proc : process(k_0_reg_81, icmp_ln15_reg_193, ap_CS_fsm_pp0_stage0, k_reg_207, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln15_reg_193 = ap_const_lv1_0))) then 
            ap_phi_mux_k_0_phi_fu_85_p4 <= k_reg_207;
        else 
            ap_phi_mux_k_0_phi_fu_85_p4 <= k_0_reg_81;
        end if; 
    end process;


    ap_phi_mux_pow_b_0_phi_fu_96_p4_assign_proc : process(pow_b_0_reg_93, ap_CS_fsm_pp0_stage1, icmp_ln15_reg_193_pp0_iter2_reg, pow_b_1_reg_217, ap_enable_reg_pp0_iter2, ap_block_pp0_stage1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln15_reg_193_pp0_iter2_reg = ap_const_lv1_0))) then 
            ap_phi_mux_pow_b_0_phi_fu_96_p4 <= pow_b_1_reg_217;
        else 
            ap_phi_mux_pow_b_0_phi_fu_96_p4 <= pow_b_0_reg_93;
        end if; 
    end process;
    ...
    grp_fu_114_p0_assign_proc : process(empty_reg_69, x_read_reg_170, ap_enable_reg_pp0_iter4, ap_phi_mux_empty_phi_fu_73_p4, ap_CS_fsm_state2, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2, ap_CS_fsm_state54)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state54)) then 
            grp_fu_114_p0 <= empty_reg_69;
            ...
            grp_fu_114_p0 <= ap_phi_mux_empty_phi_fu_73_p4;
    ...
    grp_fu_114_p1_assign_proc : process(empty_reg_69, a_reg_222, ap_enable_reg_pp0_iter4, ap_CS_fsm_state2, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2, ap_CS_fsm_state54)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state54)) then 
            grp_fu_114_p1 <= empty_reg_69;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1))) then 
            grp_fu_114_p1 <= a_reg_222;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    grp_fu_126_p0_assign_proc : process(ap_CS_fsm_pp0_stage1, b_reg_181, ap_enable_reg_pp0_iter1, ap_phi_mux_pow_b_0_phi_fu_96_p4, ap_block_pp0_stage1, ap_CS_fsm_state23)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            grp_fu_126_p0 <= ap_phi_mux_pow_b_0_phi_fu_96_p4;
    ...
    grp_fu_131_p0_assign_proc : process(ap_CS_fsm_pp0_stage1, reg_141, ap_enable_reg_pp0_iter1, ap_phi_mux_pow_b_0_phi_fu_96_p4, ap_block_pp0_stage1, ap_CS_fsm_state7, ap_CS_fsm_state59)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            grp_fu_131_p0 <= ap_phi_mux_pow_b_0_phi_fu_96_p4;
    ...
    grp_fu_138_p0 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_phi_mux_k_0_phi_fu_85_p4),32));
    ...
    k_fu_164_p2 <= std_logic_vector(unsigned(k_0_reg_81) + unsigned(ap_const_lv6_2));
