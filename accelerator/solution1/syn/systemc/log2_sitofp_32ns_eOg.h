...
// ==============================================================
#ifndef __log2_sitofp_32ns_eOg__HH__
#define __log2_sitofp_32ns_eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(log2_sitofp_32ns_eOg) {
    ...
    SC_CTOR(log2_sitofp_32ns_eOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
