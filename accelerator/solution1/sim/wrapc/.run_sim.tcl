...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "l_log2.autotvin.dat"
	set constFileTvOut       "l_log2.autotvout.dat"
	set constFileHdlTvIn     "l_log2.autohdltvin.dat"
	set constFileHdlTvOut    "l_log2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
