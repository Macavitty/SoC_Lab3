...
`define AUTOTB_DUT      l_log2
`define AUTOTB_DUT_INST AESL_inst_l_log2
`define AUTOTB_TOP      apatb_l_log2_top
`define AUTOTB_LAT_RESULT_FILE "l_log2.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "l_log2.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_l_log2_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_x 1
`define AESL_DEPTH_y 1
`define AUTOTB_TVIN_x  "../tv/cdatafile/c.l_log2.autotvin_x.dat"
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.l_log2.autotvin_x.dat"
`define AUTOTB_TVOUT_y  "../tv/cdatafile/c.l_log2.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "../tv/rtldatafile/rtl.l_log2.autotvout_y.dat"
module `AUTOTB_TOP;
